...
function methodMobilePayment(method) {
  switch (method) {
    case 'bca':
      return 'Mobile Banking BCA';
    case 'bjb':
      return 'Mobile Banking BJB';
    case 'bni':
      return 'Mobile Banking BNI';
    case 'mandiri':
      return 'Mobile Banking Mandiri';
    case 'bri':
      return 'Mobile Banking BRI';
    case 'ovo':
      return 'OVO';
    case 'dana':
      return 'Dana';
...
function methodVirtualAccount(method) {
  switch (method) {
    case 'bca':
      return 'BCAVA';
    case 'bjb':
